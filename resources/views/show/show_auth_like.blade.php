...
<body>
  <div class="container col-12">
    ...
    <div class="main col-md-12">
      ...
      <a href="/menu/{{$like->id}}" class="box col-md-5 ">
      <img src="{{$like->icon_picture}}" style="width:100%; height:100%;display:block;"></img>
      <div class="title">タイトル:{{$like->name}}<br>作成日時:{{$like->created_at}}</div>
      </a>
      @endforeach
      @endif
    </div>
